...
class CakeSerializer(serializers.Serializer):
	...
	image_url = serializers.CharField(max_length=200, validators=[check_url], label="imageUrl")
	yum_factor = serializers.IntegerField(label="yumFactor", validators=[yum_factor_check])
